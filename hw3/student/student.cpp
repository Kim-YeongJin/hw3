...
student::student(char input_id[], char input_name[], char input_addr[], char input_dofe[], char input_hours[]){
	strcpy(identifier, input_id);
	strcpy(name, input_name);
	strcpy(Address, input_addr);
	strcpy(dofe, input_dofe);
	strcpy(credit_hours, input_hours);
	}
