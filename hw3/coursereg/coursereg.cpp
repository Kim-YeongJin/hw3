...
coursereg::coursereg(char input_id[], char input_stid[], char input_hours[], char input_grade[]){
	strcpy(course_id, input_id);
	strcpy(student_id, input_stid);
	strcpy(course_credit_hours, input_hours);
	strcpy(course_grade, input_grade);
}
